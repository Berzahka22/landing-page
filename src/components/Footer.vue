    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 pb-8 lg:pb-16">
        ...
        <div class="animate-slideInLeft">
          <div class="flex items-center gap-2 group mb-6">
          ...
          <div class="flex items-center gap-3 lg:gap-4">
            ...
            <a href="#"
              ...
              <svg class="w-4 h-4 lg:w-5 lg:h-5" fill="currentColor" viewBox="0 0 24 24">
                <path
                  d="M23.953 4.57a10 10 0 002.856-3.51 10 10 0 01-2.956 1.745 4.958 4.958 0 00-8.86 4.514C7.687 9.005 4.067 7.13 1.64 4.077a4.959 4.959 0 001.535 6.6 4.928 4.928 0 01-2.25-.616c-.054 2.281 1.581 4.415 3.949 4.89a4.935 4.935 0 01-2.224.084 4.964 4.964 0 004.631 3.445A9.959 9.959 0 010 19.54a13.977 13.977 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
              </svg>
            </a>
            ...
            <a href="#"
              class="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-r from-blue-600 to-blue-700 flex items-center justify-center text-white hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-110 active:scale-95 group">
              <svg class="w-4 h-4 lg:w-5 lg:h-5" fill="currentColor" viewBox="0 0 24 24">
                <rect x="2" y="2" width="20" height="20" rx="5" ry="5" fill="url(#grad1)" />
        ...
        <div class="animate-slideInRight" style="animation-delay: 0.3s">
          ...
          <p class="text-gray-400 text-xs lg:text-sm leading-relaxed">
            Subscribe to our newsletter and unlock a world of exclusive benefits. Be the first to know about
            our latest products, special promotions, and exciting updates.
          </p>
        </div>
      </div>
